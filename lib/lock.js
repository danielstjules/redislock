 ...
 * @return {Promise}
 */
Lock.prototype.extend = function(timeout, fn) {
  var lock = this;
  var key = this._key;
  ...
  return client.extifequal(key, lock._id, timeout || this.timeout)
    .then(function (res) {
      if (res !== 1) {
...
Lock.prototype._setupClient = function (client) {
  ...
  if (!client.extifequal) {
    client.defineCommand('extifequal', {
      lua: scripts.extifequal,
      numberOfKeys: 1
    });
  }
